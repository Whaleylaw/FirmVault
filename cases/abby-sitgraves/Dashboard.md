...
> WHERE contains(map(cases, (c) => c.case), "abby-sitgraves")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/abby-sitgraves/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/abby-sitgraves/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
