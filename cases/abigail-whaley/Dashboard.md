...
> WHERE contains(map(cases, (c) => c.case), "abigail-whaley")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/abigail-whaley/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/abigail-whaley/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
