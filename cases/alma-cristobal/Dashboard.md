...
> WHERE contains(map(cases, (c) => c.case), "alma-cristobal")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/alma-cristobal/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/alma-cristobal/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
