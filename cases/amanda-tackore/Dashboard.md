...
client_name: "Amanda Tackore"
case_type: "slip_fall"
date_of_incident: 2026-01-24
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2026-01-24-SF-001"
---
...
| Field | Value |
|-------|-------|
| **Client** | Amanda Tackore |
| **Case Type** | slip_fall |
| **Date of Incident** | 2026-01-24 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2026-01-24-SF-001 |
...
> WHERE contains(map(cases, (c) => c.case), "amanda-tackore")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/amanda-tackore/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/amanda-tackore/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
