...
> WHERE contains(map(cases, (c) => c.case), "amy-mills")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/amy-mills/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
