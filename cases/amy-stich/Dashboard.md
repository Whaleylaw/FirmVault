...
> WHERE contains(map(cases, (c) => c.case), "amy-stich")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/amy-stich/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
