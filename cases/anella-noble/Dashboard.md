...
| **Date of Incident** | 2021-01-03 |
| **Current Phase** | litigation |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2021-01-03-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "anella-noble")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/anella-noble/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
