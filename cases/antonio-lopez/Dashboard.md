...
> WHERE contains(map(cases, (c) => c.case), "antonio-lopez")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/antonio-lopez/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/antonio-lopez/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
