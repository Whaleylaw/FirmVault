...
> WHERE contains(map(cases, (c) => c.case), "ashlee-williams")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/ashlee-williams/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/ashlee-williams/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
