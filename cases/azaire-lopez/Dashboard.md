...
> WHERE contains(map(cases, (c) => c.case), "azaire-lopez")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/azaire-lopez/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
