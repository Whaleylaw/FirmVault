...
> WHERE contains(map(cases, (c) => c.case), "brenda-lang")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/brenda-lang/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
