...
client_name: "Brigido Gonzalez Martinez"
case_type: "auto_accident"
date_of_incident: 2025-12-07
current_phase: "treatment"
jurisdiction: "KY"
legacy_id: "2025-12-07-MVA-001"
---

# Brigido Gonzalez Martinez

## Case Overview

| Field | Value |
|-------|-------|
| **Client** | Brigido Gonzalez Martinez |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-12-07 |
| **Current Phase** | treatment |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-12-07-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "brigido-gonzalez-martinez")
> SORT name ASC
> ```
>
...
> FROM "cases/brigido-gonzalez-martinez"
...
>   note_type as "Type"
> FROM "cases/brigido-gonzalez-martinez/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/brigido-gonzalez-martinez/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
