...
client_name: "Carmelita Wilson"
case_type: "auto_accident"
date_of_incident: 2025-10-12
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2025-10-12-MVA-001"
---
...
| Field | Value |
|-------|-------|
| **Client** | Carmelita Wilson |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-10-12 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-10-12-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "carmelita-wilson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/carmelita-wilson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/carmelita-wilson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
