...
> WHERE contains(map(cases, (c) => c.case), "caryn-mccay")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/caryn-mccay/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
