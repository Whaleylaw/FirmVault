...
client_name: "Cecelia Neltner"
case_type: "auto_accident"
date_of_incident: 2023-04-01
current_phase: "litigation"
jurisdiction: "KY"
legacy_id: "2023-04-01-MVA-001"
---
...
> WHERE contains(map(cases, (c) => c.case), "cecelia-neltner")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/cecelia-neltner/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/cecelia-neltner/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
