...
> WHERE contains(map(cases, (c) => c.case), "cecil-finley")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/cecil-finley/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
