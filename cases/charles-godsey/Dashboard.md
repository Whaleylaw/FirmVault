...
> WHERE contains(map(cases, (c) => c.case), "charles-godsey")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/charles-godsey/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/charles-godsey/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
