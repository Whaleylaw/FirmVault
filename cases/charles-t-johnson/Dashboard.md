...
> WHERE contains(map(cases, (c) => c.case), "charles-t-johnson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/charles-t-johnson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/charles-t-johnson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
