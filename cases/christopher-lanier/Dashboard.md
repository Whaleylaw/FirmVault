...
| Field | Value |
|-------|-------|
| **Client** | Christopher Lanier |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-06-28 |
| **Current Phase** | negotiation |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-06-28-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "christopher-lanier")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/christopher-lanier/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/christopher-lanier/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
