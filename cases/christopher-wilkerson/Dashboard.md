...
client_name: "Christopher Wilkerson"
case_type: "auto_accident"
date_of_incident: 2024-02-15
current_phase: "demand"
jurisdiction: "KY"
legacy_id: "2024-02-15-MVA-002"
---
...
> WHERE contains(map(cases, (c) => c.case), "christopher-wilkerson")
> SORT name ASC
> ```
>
...
> FROM "cases/christopher-wilkerson"
...
>   note_type as "Type"
> FROM "cases/christopher-wilkerson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/christopher-wilkerson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
