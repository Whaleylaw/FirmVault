...
> WHERE contains(map(cases, (c) => c.case), "clarence-robinson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/clarence-robinson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/clarence-robinson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
