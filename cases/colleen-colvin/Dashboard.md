...
> WHERE contains(map(cases, (c) => c.case), "colleen-colvin")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/colleen-colvin/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/colleen-colvin/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
