...
> WHERE contains(map(cases, (c) => c.case), "collie-williams-sr")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/collie-williams-sr/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/collie-williams-sr/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
