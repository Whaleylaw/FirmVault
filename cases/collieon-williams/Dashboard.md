...
> WHERE contains(map(cases, (c) => c.case), "collieon-williams")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/collieon-williams/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/collieon-williams/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
