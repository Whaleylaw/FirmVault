...
> WHERE contains(map(cases, (c) => c.case), "connie-goree")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/connie-goree/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
