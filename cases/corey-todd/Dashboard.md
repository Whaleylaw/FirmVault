...
client_name: "Corey Todd"
case_type: "auto_accident"
date_of_incident: 2025-08-02
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2025-08-02-MVA-001"
---
...
| **Date of Incident** | 2025-08-02 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-08-02-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "corey-todd")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/corey-todd/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
