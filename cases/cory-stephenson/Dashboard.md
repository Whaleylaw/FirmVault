...
> WHERE contains(map(cases, (c) => c.case), "cory-stephenson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/cory-stephenson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/cory-stephenson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
