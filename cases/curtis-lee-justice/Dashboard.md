...
> WHERE contains(map(cases, (c) => c.case), "curtis-lee-justice")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/curtis-lee-justice/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/curtis-lee-justice/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
