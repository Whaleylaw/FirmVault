...
| Field | Value |
|-------|-------|
| **Client** | Cynthia Gibson |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-07-09 |
| **Current Phase** | treatment |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-07-09-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "cynthia-gibson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/cynthia-gibson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/cynthia-gibson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
