...
> WHERE contains(map(cases, (c) => c.case), "dakota-mccord")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/dakota-mccord/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/dakota-mccord/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
