...
> WHERE contains(map(cases, (c) => c.case), "dana-jackson")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/dana-jackson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
