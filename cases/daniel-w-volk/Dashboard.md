...
| **Date of Incident** | 2021-09-24 |
| **Current Phase** | litigation |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2021-09-24-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "daniel-w-volk")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/daniel-w-volk/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/daniel-w-volk/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
