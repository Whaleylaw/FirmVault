...
| Field | Value |
|-------|-------|
| **Client** | Davis Robinson |
| **Case Type** | slip_fall |
| **Date of Incident** | 2025-05-02 |
| **Current Phase** | treatment |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-05-02-SF-001 |
...
> WHERE contains(map(cases, (c) => c.case), "davis-robinson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/davis-robinson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/davis-robinson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
