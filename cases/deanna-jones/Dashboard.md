...
date_of_incident: 2025-07-30
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2025-07-30-MVA-001"
---
...
| **Date of Incident** | 2025-07-30 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-07-30-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "deanna-jones")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/deanna-jones/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
