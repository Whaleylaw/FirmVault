...
client_name: "Deanna Scott"
case_type: "auto_accident"
date_of_incident: 2025-12-21
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2025-12-21-MVA-001"
---
...
| **Date of Incident** | 2025-12-21 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-12-21-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "deanna-scott")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/deanna-scott/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
