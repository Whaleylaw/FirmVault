...
> WHERE contains(map(cases, (c) => c.case), "debra-marshall")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/debra-marshall/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/debra-marshall/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
