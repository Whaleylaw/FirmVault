...
> WHERE contains(map(cases, (c) => c.case), "destiny-adkins")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/destiny-adkins/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/destiny-adkins/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
