...
> WHERE contains(map(cases, (c) => c.case), "dewayne-ward")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/dewayne-ward/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
