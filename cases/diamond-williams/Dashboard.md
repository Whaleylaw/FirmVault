...
client_name: "Diamond Williams"
case_type: "auto_accident"
date_of_incident: 2025-12-23
current_phase: "file_setup"
jurisdiction: "KY"
legacy_id: "2025-12-23-MVA-002"
---
...
> WHERE contains(map(cases, (c) => c.case), "diamond-williams")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/diamond-williams/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/diamond-williams/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
