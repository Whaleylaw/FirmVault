...
| **Date of Incident** | 2023-01-19 |
| **Current Phase** | litigation |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2023-01-19-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "douglas-livers")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/douglas-livers/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/douglas-livers/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
