...
> WHERE contains(map(cases, (c) => c.case), "elizabeth-lindsey")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/elizabeth-lindsey/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/elizabeth-lindsey/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
