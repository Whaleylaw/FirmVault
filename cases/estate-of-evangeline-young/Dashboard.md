...
jurisdiction: "KY"
legacy_id: "2023-08-12-MVA-001"
---

# Estate of Evangeline Young

## Case Overview

| Field | Value |
|-------|-------|
| **Client** | Estate of Evangeline Young |
| **Case Type** | auto_accident |
| **Date of Incident** | 2023-08-12 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2023-08-12-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "estate-of-evangeline-young")
> SORT name ASC
> ```
>
...
> FROM "cases/estate-of-evangeline-young"
...
>   note_type as "Type"
> FROM "cases/estate-of-evangeline-young/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/estate-of-evangeline-young/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
