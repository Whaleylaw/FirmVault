...
> WHERE contains(map(cases, (c) => c.case), "forrest-muss")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/forrest-muss/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
