...
> WHERE contains(map(cases, (c) => c.case), "frances-whitis")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/frances-whitis/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/frances-whitis/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
