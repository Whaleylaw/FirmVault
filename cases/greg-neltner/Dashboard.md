...
> WHERE contains(map(cases, (c) => c.case), "greg-neltner")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/greg-neltner/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
