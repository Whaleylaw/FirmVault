...
| Field | Value |
|-------|-------|
| **Client** | Henrietta Jenkins |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-05-20 |
| **Current Phase** | negotiation |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-05-20-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "henrietta-jenkins")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/henrietta-jenkins/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/henrietta-jenkins/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
