...
> WHERE contains(map(cases, (c) => c.case), "hope-renee-padgett")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/hope-renee-padgett/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/hope-renee-padgett/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
