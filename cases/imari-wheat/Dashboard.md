...
client_name: "Imari Wheat"
case_type: "auto_accident"
date_of_incident: 2026-01-23
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2026-01-23-MVA-001"
---
...
| **Date of Incident** | 2026-01-23 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2026-01-23-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "imari-wheat")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/imari-wheat/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
