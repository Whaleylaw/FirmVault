...
| **Date of Incident** | 2025-06-17 |
| **Current Phase** | treatment |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-06-17-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "jacob-herrle")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/jacob-herrle/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
