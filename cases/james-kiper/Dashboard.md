...
> WHERE contains(map(cases, (c) => c.case), "james-kiper")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/james-kiper/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
