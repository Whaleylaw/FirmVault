...
> WHERE contains(map(cases, (c) => c.case), "james-lanier")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/james-lanier/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
