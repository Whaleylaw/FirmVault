...
> WHERE contains(map(cases, (c) => c.case), "james-sadler")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/james-sadler/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
