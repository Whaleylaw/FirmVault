...
> WHERE contains(map(cases, (c) => c.case), "jasmine-wilson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/jasmine-wilson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/jasmine-wilson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
