...
> WHERE contains(map(cases, (c) => c.case), "jaysha-aponte")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/jaysha-aponte/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/jaysha-aponte/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
