...
| **Date of Incident** | 2025-08-06 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-08-06-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "jensen-ott")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/jensen-ott/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
