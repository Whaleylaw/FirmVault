...
> WHERE contains(map(cases, (c) => c.case), "jeremy-lindsey")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/jeremy-lindsey/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/jeremy-lindsey/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
