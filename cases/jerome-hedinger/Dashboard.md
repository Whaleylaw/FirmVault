...
client_name: "Jerome Hedinger"
case_type: "premises_liability"
date_of_incident: 2023-10-24
current_phase: "litigation"
jurisdiction: "KY"
legacy_id: "2023-10-24-PrL-001"
---
...
> WHERE contains(map(cases, (c) => c.case), "jerome-hedinger")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/jerome-hedinger/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/jerome-hedinger/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
