...
> WHERE contains(map(cases, (c) => c.case), "jimmy-ferguson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/jimmy-ferguson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/jimmy-ferguson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
