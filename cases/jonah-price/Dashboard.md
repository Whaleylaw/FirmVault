...
date_of_incident: 2025-08-25
current_phase: "file_setup"
jurisdiction: "KY"
legacy_id: "2025-08-25-MVA-001"
---
...
| **Date of Incident** | 2025-08-25 |
| **Current Phase** | file_setup |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-08-25-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "jonah-price")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/jonah-price/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
