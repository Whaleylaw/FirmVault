...
> WHERE contains(map(cases, (c) => c.case), "joseph-ott")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/joseph-ott/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
