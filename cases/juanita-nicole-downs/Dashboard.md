...
> WHERE contains(map(cases, (c) => c.case), "juanita-nicole-downs")
> SORT name ASC
> ```
>
...
> FROM "cases/juanita-nicole-downs"
...
>   note_type as "Type"
> FROM "cases/juanita-nicole-downs/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/juanita-nicole-downs/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
