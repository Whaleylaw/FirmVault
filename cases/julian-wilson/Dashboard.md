...
> WHERE contains(map(cases, (c) => c.case), "julian-wilson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/julian-wilson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/julian-wilson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
