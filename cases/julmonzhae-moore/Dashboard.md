...
| **Date of Incident** | 2023-08-29 |
| **Current Phase** | litigation |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2023-08-29-MVA-003 |
...
> WHERE contains(map(cases, (c) => c.case), "julmonzhae-moore")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/julmonzhae-moore/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/julmonzhae-moore/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
