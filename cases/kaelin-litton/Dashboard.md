...
> WHERE contains(map(cases, (c) => c.case), "kaelin-litton")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/kaelin-litton/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/kaelin-litton/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
