...
| Field | Value |
|-------|-------|
| **Client** | K'daya Austin |
| **Case Type** | None |
| **Date of Incident** | 2026-02-05 |
...
> WHERE contains(map(cases, (c) => c.case), "kdaya-austin")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/kdaya-austin/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
