...
> WHERE contains(map(cases, (c) => c.case), "kimberly-brasher")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/kimberly-brasher/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/kimberly-brasher/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
