...
> WHERE contains(map(cases, (c) => c.case), "laniaya-wilson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/laniaya-wilson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/laniaya-wilson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
