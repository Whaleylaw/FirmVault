...
> WHERE contains(map(cases, (c) => c.case), "leanora-brown")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/leanora-brown/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/leanora-brown/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
