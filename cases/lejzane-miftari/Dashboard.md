...
| Field | Value |
|-------|-------|
| **Client** | Lejzane Miftari |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-06-18 |
| **Current Phase** | treatment |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-06-18-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "lejzane-miftari")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/lejzane-miftari/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/lejzane-miftari/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
