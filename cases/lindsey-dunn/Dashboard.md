...
> WHERE contains(map(cases, (c) => c.case), "lindsey-dunn")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/lindsey-dunn/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
