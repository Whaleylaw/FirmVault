...
| **Date of Incident** | 2025-11-19 |
| **Current Phase** | file_setup |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-11-19-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "lori-house")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/lori-house/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
