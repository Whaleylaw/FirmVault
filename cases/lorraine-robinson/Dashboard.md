...
client_name: "Lorraine Robinson"
case_type: "auto_accident"
date_of_incident: 2025-11-13
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2025-11-13-MVA-001"
---
...
| Field | Value |
|-------|-------|
| **Client** | Lorraine Robinson |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-11-13 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-11-13-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "lorraine-robinson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/lorraine-robinson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/lorraine-robinson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
