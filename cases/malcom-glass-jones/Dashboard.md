...
date_of_incident: 2024-10-02
current_phase: "negotiation"
jurisdiction: "KY"
legacy_id: "2024-10-02-MVA-001"
---
...
> WHERE contains(map(cases, (c) => c.case), "malcom-glass-jones")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/malcom-glass-jones/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/malcom-glass-jones/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
