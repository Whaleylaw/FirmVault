...
> WHERE contains(map(cases, (c) => c.case), "maryan-kassim")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/maryan-kassim/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/maryan-kassim/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
