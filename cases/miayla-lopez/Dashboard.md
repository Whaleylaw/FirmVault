...
> WHERE contains(map(cases, (c) => c.case), "miayla-lopez")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/miayla-lopez/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
