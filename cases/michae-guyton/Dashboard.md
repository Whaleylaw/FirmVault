...
> WHERE contains(map(cases, (c) => c.case), "michae-guyton")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/michae-guyton/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/michae-guyton/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
