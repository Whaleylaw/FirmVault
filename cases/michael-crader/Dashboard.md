...
> WHERE contains(map(cases, (c) => c.case), "michael-crader")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/michael-crader/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/michael-crader/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
