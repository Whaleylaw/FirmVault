...
| **Date of Incident** | 2025-10-31 |
| **Current Phase** | treatment |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-10-31-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "michael-deshields")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/michael-deshields/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/michael-deshields/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
