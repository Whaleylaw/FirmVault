...
> WHERE contains(map(cases, (c) => c.case), "michael-ditto-jr")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/michael-ditto-jr/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/michael-ditto-jr/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
