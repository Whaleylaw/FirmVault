...
> WHERE contains(map(cases, (c) => c.case), "michael-johnston")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/michael-johnston/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/michael-johnston/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
