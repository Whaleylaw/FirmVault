...
> WHERE contains(map(cases, (c) => c.case), "michael-lanier")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/michael-lanier/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/michael-lanier/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
