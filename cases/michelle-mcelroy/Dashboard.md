...
client_name: "Michelle McElroy"
case_type: "auto_accident"
date_of_incident: 2025-12-28
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2025-12-28-MVA-001"
---
...
| Field | Value |
|-------|-------|
| **Client** | Michelle McElroy |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-12-28 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-12-28-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "michelle-mcelroy")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/michelle-mcelroy/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/michelle-mcelroy/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
