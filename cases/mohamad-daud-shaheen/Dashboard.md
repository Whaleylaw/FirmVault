...
jurisdiction: "KY"
legacy_id: "2025-12-24-MVA-001"
---

# Mohamad Daud Shaheen

## Case Overview

| Field | Value |
|-------|-------|
| **Client** | Mohamad Daud Shaheen |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-12-24 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-12-24-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "mohamad-daud-shaheen")
> SORT name ASC
> ```
>
...
> FROM "cases/mohamad-daud-shaheen"
...
>   note_type as "Type"
> FROM "cases/mohamad-daud-shaheen/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/mohamad-daud-shaheen/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
