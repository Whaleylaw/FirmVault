...
> WHERE contains(map(cases, (c) => c.case), "muhammad-alif")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/muhammad-alif/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/muhammad-alif/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
