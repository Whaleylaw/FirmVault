...
> WHERE contains(map(cases, (c) => c.case), "nayram-adadevoh")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/nayram-adadevoh/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/nayram-adadevoh/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
