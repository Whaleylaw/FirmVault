...
| **Date of Incident** | 2025-07-05 |
| **Current Phase** | treatment |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-07-05-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "nicole-tewes")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/nicole-tewes/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
