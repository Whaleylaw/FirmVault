...
date_of_incident: 2025-05-27
current_phase: "file_setup"
jurisdiction: "KY"
legacy_id: "2025-05-27-MVA-001"
---
...
> WHERE contains(map(cases, (c) => c.case), "prince-ngabonziza")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/prince-ngabonziza/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/prince-ngabonziza/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
