...
| Field | Value |
|-------|-------|
| **Client** | Raymond Hunter |
| **Case Type** | other |
| **Date of Incident** | 2025-12-18 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-12-18-OTH-001 |
...
> WHERE contains(map(cases, (c) => c.case), "raymond-hunter")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/raymond-hunter/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/raymond-hunter/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
