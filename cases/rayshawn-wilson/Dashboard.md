...
| Field | Value |
|-------|-------|
| **Client** | Rayshawn Wilson |
| **Case Type** | auto_accident |
| **Date of Incident** | 2025-04-10 |
| **Current Phase** | treatment |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-04-10-MVA-001 |
...
> WHERE contains(map(cases, (c) => c.case), "rayshawn-wilson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/rayshawn-wilson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/rayshawn-wilson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
