...
> WHERE contains(map(cases, (c) => c.case), "rebecca-lanier")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/rebecca-lanier/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/rebecca-lanier/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
