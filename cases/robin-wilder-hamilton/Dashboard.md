...
> WHERE contains(map(cases, (c) => c.case), "robin-wilder-hamilton")
> SORT name ASC
> ```
>
...
> FROM "cases/robin-wilder-hamilton"
...
>   note_type as "Type"
> FROM "cases/robin-wilder-hamilton/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/robin-wilder-hamilton/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
