...
> WHERE contains(map(cases, (c) => c.case), "robin-willis-beck")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/robin-willis-beck/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/robin-willis-beck/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
