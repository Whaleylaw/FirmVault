...
> WHERE contains(map(cases, (c) => c.case), "samuel-clites")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/samuel-clites/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/samuel-clites/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
