...
> WHERE contains(map(cases, (c) => c.case), "sariya-mason")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/sariya-mason/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
