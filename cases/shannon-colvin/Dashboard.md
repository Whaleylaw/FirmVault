...
> WHERE contains(map(cases, (c) => c.case), "shannon-colvin")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/shannon-colvin/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/shannon-colvin/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
