...
> WHERE contains(map(cases, (c) => c.case), "shannon-lankswert")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/shannon-lankswert/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/shannon-lankswert/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
