...
> WHERE contains(map(cases, (c) => c.case), "stevie-hawks")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/stevie-hawks/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
