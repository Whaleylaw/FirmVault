...
> WHERE contains(map(cases, (c) => c.case), "taylor-thompson")
> SORT name ASC
> ```
>
...
>   note_type as "Type"
> FROM "cases/taylor-thompson/notes"
> SORT file.cday DESC
> LIMIT 20
> ```
>
...
>   file.cday as "Added"
> FROM "cases/taylor-thompson/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
