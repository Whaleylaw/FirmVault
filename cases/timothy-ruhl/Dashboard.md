...
> WHERE contains(map(cases, (c) => c.case), "timothy-ruhl")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/timothy-ruhl/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
