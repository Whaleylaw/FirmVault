...
case_type: "slip_fall"
date_of_incident: 2025-04-02
current_phase: "onboarding"
jurisdiction: "KY"
legacy_id: "2025-04-02-SF-001"
---
...
| **Client** | Tina Smith |
| **Case Type** | slip_fall |
| **Date of Incident** | 2025-04-02 |
| **Current Phase** | onboarding |
| **Jurisdiction** | KY |
| **SOL Deadline** | `= this.sol_deadline` |
| **Legacy ID** | 2025-04-02-SF-001 |
...
> WHERE contains(map(cases, (c) => c.case), "tina-smith")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/tina-smith/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
