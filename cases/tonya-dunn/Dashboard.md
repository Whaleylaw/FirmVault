...
> WHERE contains(map(cases, (c) => c.case), "tonya-dunn")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/tonya-dunn/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
