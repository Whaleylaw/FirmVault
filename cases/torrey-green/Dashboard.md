...
> WHERE contains(map(cases, (c) => c.case), "torrey-green")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/torrey-green/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
