...
> WHERE contains(map(cases, (c) => c.case), "wayne-weber")
> SORT name ASC
> ```
>
...
>   file.cday as "Added"
> FROM "cases/wayne-weber/documents"
> SORT file.cday DESC
> LIMIT 30
> ```
>
