...
1. **Read the document:**
   ...
   - For emails, read `.md` companion if available
...
**Priority:**
1. Use `read_multimodal_file` tool to read PDFs directly
2. For emails, read `.md` companion if available

**File Reading Examples:**

```bash
# Read PDF directly with read_multimodal_file tool
read_multimodal_file("/path/to/file.pdf")

# Read email markdown if available
