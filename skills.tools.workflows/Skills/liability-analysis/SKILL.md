...
4. DOCUMENT ANALYSIS
   └── Save to `cases/<slug>/claims/` and `## Insurance Claims` section → liability_analysis
```
...
- Liability analysis documented in `cases/<slug>/claims/` and `## Insurance Claims` section
