...
spawn_sub_agent(
    ...
    skill="multimedia-evidence-analysis",  # Relative to Skills directory
    task=f"""
...
**DO provide the skill name** when spawning the sub-agent: `multimedia-evidence-analysis` (relative to Skills directory)
