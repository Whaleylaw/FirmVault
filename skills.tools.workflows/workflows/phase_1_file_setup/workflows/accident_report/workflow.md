...
**Creates:**
- Insurance entries in the graph (query InsurancePolicy/BIClaim/PIPClaim nodes) for each identified carrier
- At-fault party entries in the graph (query Client/Attorney/Adjuster nodes)
- Witness entries in the graph (query Client/Attorney/Adjuster nodes)
