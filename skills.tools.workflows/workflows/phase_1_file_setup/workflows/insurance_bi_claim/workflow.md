...
**Completion Check:** graph field (see InsurancePolicy/Claim schema) is populated
...
**Completion Check:** graph field (see InsurancePolicy/Claim schema) is populated (not "investigating")
